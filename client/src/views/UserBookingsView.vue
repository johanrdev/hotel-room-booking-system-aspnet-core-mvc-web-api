          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <tr v-for="booking in bookings" :key="booking.id">
                ...
                <td class="px-6 py-4 whitespace-nowrap">${{ booking.room.price }}</td>
                <td class="px-6 py-4 whitespace-nowrap">{{ calculateDays(booking.checkInDate, booking.checkOutDate) }}</td>
                <td class="px-6 py-4 whitespace-nowrap">${{ calculateTotalPrice(booking.room.price, booking.checkInDate, booking.checkOutDate) }}</td>
